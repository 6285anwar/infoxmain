...
def MAN_proname(request,id):
    if 'm_id' in request.session:
        ...
        for i in queryset:
            ...
            data=[i.workperformance,i.attitude,i.creativity]
        return render(request,'MAN_proname.html',{'pro_man_data':Project_man_data,'mem':mem,'labels':labels,'data':data})
    else:
        return redirect('/')
...
def BRadmin_proname(request,id):
    if 'Adm_id' in request.session:
        ...
        return render(request,'BRadmin_proname.html',{'pro_man_data':Project_man_data,'Adm':Adm,'labels':labels,'data':data})
    else:
        return redirect('/')
